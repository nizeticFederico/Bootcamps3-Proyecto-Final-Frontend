            ...
            <div className="flex flex-wrap justify-center w-full p-8 space-x-4 ">
                <div className="w-56 h-60 bg-white p-5 rounded-lg cursor-pointer transition duration-500 hover:shadow-lg hover:shadow-gray-500">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            />
                        <strong className="text-lg text-gray-800">Fede Nizetic</strong>
                        </div>
                ...
                <div className="w-56 h-60 bg-white p-5 rounded-lg cursor-pointer transition duration-500 hover:shadow-lg hover:shadow-gray-500">
                        ...
                        <div className="flex flex-col items-center">
                            <Image
                                ...
                                alt="Picture of the author"
                            />
                        <strong className="text-lg text-gray-800">Augusto Catterino</strong>
                        </div>
                        <div className="flex justify-center mt-4 space-x-4 text-gray-600">
                        <a href="" target="_blank">
                                <Image
                ...
                <div className="w-56 h-60 bg-white p-5 rounded-lg cursor-pointer transition duration-500 hover:shadow-lg hover:shadow-gray-500">
                        ...
                        <div className="flex flex-col items-center">
                            <Image
                                ...
                                alt="Picture of the author"
                            />
                        <strong className="text-lg text-gray-800">Pablo Merino</strong>
                        </div>
                        <div className="flex justify-center mt-4 space-x-4 text-gray-600">
                        <a href="" target="_blank">
                                <Image
                ...
                <div className="w-56 h-60 bg-white p-5 rounded-lg cursor-pointer transition duration-500 hover:shadow-lg hover:shadow-gray-500">
                        ...
                        <div className="flex flex-col items-center">
                            <Image
                                ...
                                alt="Picture of the author"
                            />
                        <strong className="text-lg text-gray-800">Rodolfo Villalba</strong>
                        </div>
                        <div className="flex justify-center mt-4 space-x-4 text-gray-600">
                        <a href="" target="_blank">
                                <Image
                ...
                <div className="w-56 h-60 bg-white p-5 rounded-lg cursor-pointer transition duration-500 hover:shadow-lg hover:shadow-gray-500">
                        ...
                        <div className="flex flex-col items-center">
                            <Image
                                ...
                                alt="Picture of the author"
                            />
                        <strong className="text-lg text-gray-800">Ruben Ledesma</strong>
                        </div>
                        <div className="flex justify-center mt-4 space-x-4 text-gray-600">
                            <a href="https://www.linkedin.com/in/rubendledesma/" target="_blank">
                                <Image
                                    src="/assets/images/linkedin.png"
                                    width={30}
                                    height={30}
